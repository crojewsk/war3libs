...
#$ret = & $Jasshelper $Params # | Wait-Process
#Start-Process -FilePath $Jasshelper -ArgumentList $Params -Wait
Write-Host 'output: ' $ret

& 'E:\Games\Warcraft III\Warcraft III.exe' @('-window', '-loadfile', 'C:\Users\Bannar\Documents\GitHub\island-troll-tribes\_build\Island Troll Tribes v3.0k.w3x')